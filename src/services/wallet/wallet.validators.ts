...
export const invalidPolkadotPrivateKeyOrMnemonicError: string =
  'The privateKey param is not a valid Polkadot private key or mnemonic.';
...
export const validatePrivateKey: Validator = mkSelectingValidator(
  ...
  (req, key) => req[key],
  {
    ...
    polkadot: mkValidator(
      'privateKey',
      invalidPolkadotPrivateKeyOrMnemonicError,
      (val) => typeof val === 'string' && isPolkadotPrivateKeyOrMnemonic(val),
    ),
  },
);
